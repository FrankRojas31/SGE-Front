...
<template>
  <AppLayout>
    <div class="flex justify-center items-center  py-3">
      <div
        class="w-full max-w-4xl bg-white shadow-2xl rounded-3xl overflow-hidden transition-all duration-300">
        <div class="p-10">
          <Toast />
          <div class="flex flex-col items-center text-center space-y-4">
            ...
            <h3 class="text-4xl font-bold text-gray-900 tracking-tight">{{ userStore.user.name }}</h3>
            <p class="text-xl text-gray-500">{{ userStore.user.email }}</p>
          </div>
          ...
          <div class="mt-10 border-t border-gray-200 pt-8">
            ...
            <div class="space-y-4">
              <div class="flex items-center">
                ...
                <p class="text-lg text-gray-600">{{ userStore.user.phone || 'No especificado' }}</p>
              </div>
              <div class="flex items-start">
                ...
                <p class="text-lg text-gray-600">{{ userStore.user.address || 'No especificada' }}</p>
              </div>
            </div>
          </div>
