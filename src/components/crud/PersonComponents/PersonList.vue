...
const HandleEdit = async (id: number) => {
  ...
  if (response?.success) {
    ...
    toast.add({ severity: "error", summary: "No se encontró a la persona", detail: "Verifica su existencia", life: 2000 });
  }
};
...
const EditConfirm = async (person: IPerson) => {
  ...
  if (response?.success) {
    ...
    toast.add({ severity: "success", summary: "¡Actualizado Correctamente!", detail: "Se ha actualizado la persona", life: 2000 });
  } else {
...
const CreateConfirm = async (person: IPerson) => {
  ...
  if (response?.success) {
    ...
    toast.add({ severity: "success", summary: "¡Creado Correctamente!", detail: "Se ha creado la persona", life: 2000 });
  } else {
    toast.add({ severity: "error", summary: "¡Ocurrió un error!", detail: response?.message, life: 2000 });
  }
};
...
const DeleteConfirm = async (id: number) => {
  ...
  if (response?.success) {
    ...
    toast.add({ severity: "success", summary: "¡Eliminado Correctamente!", detail: "Se ha eliminado la persona", life: 2000 });
  } else {
    toast.add({ severity: "error", summary: "¡Ocurrió un error!", detail: response?.message, life: 2000 });
  }
};
